...
const GalleryHeader = () => {
  return (
    <div className="text-center mb-14 px-4 font-inter relative">
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#3B82F6] to-[#6366F1] text-white text-[10px] font-bold uppercase tracking-widest mb-6 shadow-md relative overflow-hidden">
