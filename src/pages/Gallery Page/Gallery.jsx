...
const Gallery = () => {
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-b from-[#E0F2FE] via-white to-[#E0E7FF] py-24 font-inter overflow-hidden selection:bg-[#E0E7FF] selection:text-[#1E1B4B]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center my-12 opacity-80">
            ...
            <div className="mx-6 text-[10px] tracking-[0.25em] text-[#4B5563]/60 font-bold uppercase">
              Curated Showcase
            </div>
          ...
          {filteredItems.length === 0 && (
            <div className="text-center text-[#4B5563] mt-24 max-w-md mx-auto bg-white/60 backdrop-blur-md border border-[#E0E7FF] py-16 px-8 rounded-3xl shadow-sm">
      ...
      {/* Layer 1: Immersive Full Screen Album Dashboard Component Overlay */}
      {activeAlbum && (
        <div className="fixed inset-0 bg-[#1E1B4B]/80 backdrop-blur-md z-40 flex items-center justify-center p-4 md:p-12 transition-all duration-300 animate-in fade-in">
          <div className="bg-gradient-to-b from-[#E0F2FE]/90 to-white/95 w-full h-full md:max-w-6xl md:h-[80vh] md:rounded-[24px] border border-white/60 shadow-[0_30px_60px_-15px_rgba(30,27,75,0.4)] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="flex-1 overflow-y-auto p-8 content-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {activeAlbum.map((imgUrl, idx) => (
                ...
                >
                  <img 
                    src={imgUrl} 
                    alt="Event content capturing item" 
            ...
            {/* Modal Control Footer Information Tab */}
      ...
      {/* Layer 2: Standalone Lightbox Target Node Viewport */}
      {maximizedImage && (
        <div 
          className="fixed inset-0 bg-slate-950/90 z-50 flex flex-col items-center justify-center p-4 animate-in fade-in duration-200"
          onClick={() => setMaximizedImage(null)}
        >
          {/* Separate Layout Action Close Button */}
          <button 
          ...
          <div className="relative max-w-5xl max-h-[85vh] flex items-center justify-center select-none" onClick={(e) => e.stopPropagation()}>
            <img 
              src={maximizedImage} 
              alt="Maximized focus capture display view" 
