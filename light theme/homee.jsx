export default function Home() {
  ...
  return (
    <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-100 via-white to-indigo-100 py-20">
        ...
        {/* Subtle grid pattern - fixed without inline SVG issues */}
        <div 
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2">
          {/* Image Slider with glassmorphism */}
          ...
          <div className="order-2 lg:order-1 space-y-7 animate-fadeLeft">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="/about"
                className="inline-flex items-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 font-semibold text-white shadow-lg shadow-blue-500/30 transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                Explore E-Cell →
              </a>
              <a
                href="/contact"
                className="inline-flex items-center rounded-full border-2 border-blue-200 bg-white/60 px-8 py-4 font-semibold text-blue-700 backdrop-blur-sm transition-all duration-300 hover:bg-blue-50 hover:border-blue-300"
              >
                Contact Us
              </a>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {["Startup Ecosystem", "E-Summit", "Founder Talks", "Innovation"].map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-blue-100 bg-white/80 px-4 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur-sm transition-all duration-200 hover:bg-blue-50 hover:border-blue-200 hover:scale-105"
                >
                  {tag}
                </span>
              ))}
      ...
      {/* About Section */}
      <div className="relative bg-white/80 backdrop-blur-sm py-20 px-6">
